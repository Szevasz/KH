<template>
    <div class="container">
        <div class="form-class">
            <img class="logo" src="../assets/fitness.png" alt />
            <el-card class="card">
                <el-form :model="form" :rules="rules" ref="form" label-width="80px">
                    <div v-if="!forgetPwd">
                        <!-- 账号密码登录 -->
                        <div v-if="form.type == '1'">
                            <el-form-item label="账号" prop="username" style="margin-left: -30px;">
                                <el-input v-model="form.username" />
                            </el-form-item>
                            <el-form-item label="密码" prop="password" style="margin-left: -30px;">
                        ...
                        <div v-if="form.type == '2'">
                            ...
                            <el-form-item label="验证码" prop="code">
                                <el-input v-model="form.code" placeholder="请输入验证码">
                                    <el-button slot="append" @click="sendSms" :disabled="codeDisabled">{{ codeText
                                    }}</el-button>
                                </el-input>
                            </el-form-item>
                        </div>
                        <el-form-item style="margin-left: -40px; margin-top: 40px;">
                            <el-button type="primary" @click="submit" :loading="load" style="width: 80%">{{ loginText
                            }}</el-button>
